...
lazy_static! {
    pub static ref COMMAND_ANALYZE: Command = Command::new(CommandName::KataAnalyze, Some(Args::string("interval 50 ownership false maxmoves 30".to_owned())));
    pub static ref COMMAND_ANALYZE_OWNERSHIP: Command = Command::new(CommandName::KataAnalyze, Some(Args::string("interval 50 ownership true maxmoves 30".to_owned())));
